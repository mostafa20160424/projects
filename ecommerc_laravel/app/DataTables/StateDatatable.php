...
use App\State;//model that will read and insert  from him
...
class StateDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
      //php artisan datatables:make name
        return datatables($query)
            ->addColumn('edit', 'admin.states.action.edit')//addColumn(name,view path)
            ->addColumn('delete', 'admin.states.action.delete')//addColumn(name,view path)
            ->addColumn('checkbox', 'admin.states.action.checkbox')//addColumn(name,view path)
    ...
    public function query()
    {
        ...
        //modelname::query()
        //with('country_id')->select('cities.*'); will return country_id object
    }
    ...
    protected function getColumns()
    {
        ...
        return [
          ...
          [
            'name'=>'state_name_ar',//column name
            'data'=>'state_name_ar',//column name in database
            'title'=>trans('admin.state_name_ar'),
          ],
          [
            'name'=>'state_name_en',//column name
            'data'=>'state_name_en',//column name in database
            'title'=>trans('admin.state_name_en'),
          ],
          [
            'name'=>'country_id.country_name_'.lang(),//column name
            'data'=>'country_id.country_name_'.lang(),//column name in database
            'title'=>trans('admin.country'),
          ],
            [
                'name'=>'city_id.city_name_'.lang(),//column name
                'data'=>'city_id.city_name_'.lang(),//column name in database
