...
use App\ManuFacture;//model that will read and insert  from him
...
class ManuFactureDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
      //php artisan datatables:make name
        return datatables($query)
            ->addColumn('edit', 'admin.manufactures.action.edit')//addColumn(name,view path)
            ->addColumn('delete', 'admin.manufactures.action.delete')//addColumn(name,view path)
            ->addColumn('checkbox', 'admin.manufactures.action.checkbox')//addColumn(name,view path)
    ...
    {
        return ManuFacture::query();//modelname::query()
    }
    ...
    protected function getColumns()
    {
        ...
        return [
          ...
          [
            'name'=>'manufacture_name_ar',//column name
            'data'=>'manufacture_name_ar',//column name in database
            'title'=>trans('admin.manufacture_name_ar'),
          ],
          [
            'name'=>'manufacture_name_en',//column name
            'data'=>'manufacture_name_en',//column name in database
            'title'=>trans('admin.manufacture_name_en'),
          ],
            [
            ...
            [
                'name'=>'mobile',//column name
                'data'=>'mobile',//column name in database
                'title'=>trans('admin.mobile'),
            ],
            [
                'name'=>'contact_me',//column name
                'data'=>'contact_me',//column name in database
                'title'=>trans('admin.contact_me'),
            ],
          [
    ...
    {
        return 'manufactures' . date('YmdHis');
    }
}
