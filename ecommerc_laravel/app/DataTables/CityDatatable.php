...
use App\City;//model that will read and insert  from him
...
class CityDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
      //php artisan datatables:make name
        return datatables($query)
            ->addColumn('edit', 'admin.cities.action.edit')//addColumn(name,view path)
            ->addColumn('delete', 'admin.cities.action.delete')//addColumn(name,view path)
            ->addColumn('checkbox', 'admin.cities.action.checkbox')//addColumn(name,view path)
    ...
    protected function getColumns()
    {
        ...
        return [
          ...
          [
            'name'=>'city_name_ar',//column name
            'data'=>'city_name_ar',//column name in database
            'title'=>trans('admin.city_name_ar'),
          ],
          [
            'name'=>'city_name_en',//column name
            'data'=>'city_name_en',//column name in database
