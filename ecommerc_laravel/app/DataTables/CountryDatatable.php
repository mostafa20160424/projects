...
use App\Country;//model that will read and insert  from him
...
class CountryDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
      //php artisan datatables:make name
        return datatables($query)
            ->addColumn('edit', 'admin.countries.action.edit')//addColumn(name,view path)
            ->addColumn('delete', 'admin.countries.action.delete')//addColumn(name,view path)
            ->addColumn('checkbox', 'admin.countries.action.checkbox')//addColumn(name,view path)
    ...
    {
        return Country::query();//modelname::query()
    }
    ...
    protected function getColumns()
    {
        ...
        return [
          ...
          [
            'name'=>'country_name_ar',//column name
            'data'=>'country_name_ar',//column name in database
            'title'=>trans('admin.country_name_ar'),
          ],
          [
            'name'=>'country_name_en',//column name
            'data'=>'country_name_en',//column name in database
