...
@section('content')
    ...
    @push('js')
        <script type="text/javascript">
            $(function () {
                ...
                $('#jsTree').jstree({
                    "core" : {
                        'data' : {!! load_dep($dep->parent_id,$dep->id) !!},
                        'themes':{
                            'variant':"large"
                        }
                        /*data:[
  ...
  <div class="box">
    ...
    <div class="box-body">
        {!! Form::open(['url'=>aurl('departments/')."/".$dep->id,'files'=>true]) !!}
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            {!! Form::file('icon',['class'=>"form-control"]) !!}
              @if(!empty($dep->icon))
                  <img src="{{ Storage::url($dep->icon) }}" alt="" style="width: 100px;height: 100px;">
              @endif
          </div>
            ...
            /*
              ...
              {!!
               ...
               ['class'=>"form-control",'id'=>"5","placeholder"=>"another option vakue","id"=>""])
                ...
                {!! Form::input type('name',$dep->email'),['class'=>"form-control",attr like id]) !!}
