...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php
     /*
     aurl is helper function i create but register the file namespace that have the function in composer.json
      in files array and then run the command composer dump:autoload
     */
      ?>
