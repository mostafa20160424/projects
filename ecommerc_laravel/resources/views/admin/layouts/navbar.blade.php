...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <img src="{{ url('design/adminlit') }}/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
      </div>
  ...
  <li class="treeview {{ active_menu('countries')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('countries')[1] }}">
      <li class=""><a href="{{ aurl('countries') }}"><i class="fa fa-users"></i> {{ trans('admin.countries') }}</a></li>
  ...
  <li class="treeview {{ active_menu('cities')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
      <li class=""><a href="{{ aurl('cities') }}"><i class="fa fa-users"></i> {{ trans('admin.cities') }}</a></li>
      ...
      <li class="treeview {{ active_menu('states')[0] }}">
        ...
        <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
          <li class=""><a href="{{ aurl('states') }}"><i class="fa fa-users"></i> {{ trans('admin.states') }}</a></li>
          <li class=""><a href="{{ aurl('states/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add') }}</a></li>
        </ul>
      </li>
      <li class="treeview {{ active_menu('departments')[0] }}">
        <a href="#">
          <i class="fa fa-flag"></i> <span>{{ trans('admin.departments') }}</span>
          <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>
        </a>
        <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
          <li class=""><a href="{{ aurl('departments') }}"><i class="fa fa-users"></i> {{ trans('admin.departments') }}</a></li>
      ...
      <li class="treeview {{ active_menu('trademarks')[0] }}">
        ...
        <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
          <li class=""><a href="{{ aurl('trademarks') }}"><i class="fa fa-users"></i> {{ trans('admin.trademarks') }}</a></li>
      ...
      <li class="treeview {{ active_menu('manufactures')[0] }}">
        <a href="#">
          <i class="fa fa-flag"></i> <span>{{ trans('admin.manufactures') }}</span>
          <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>
        </a>
        <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
          <li class=""><a href="{{ aurl('manufactures') }}"><i class="fa fa-users"></i> {{ trans('admin.manufactures') }}</a></li>
